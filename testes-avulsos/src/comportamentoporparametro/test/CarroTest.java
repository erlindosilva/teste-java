package comportamentoporparametro.test;
...
import comportamentoporparametro.predicate.CarrosCorVerdePredicate;
import comportamentoporparametro.predicate.CarrosDezAnosRecentePredicate;
...
public class CarroTest {
	...
	public static void main(String[] args) {
		List<Carro> carros = asList(new Carro("verde", 2011), new Carro("vermelho", 1995),
